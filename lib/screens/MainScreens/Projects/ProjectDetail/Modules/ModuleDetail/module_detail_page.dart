...
import 'package:plane/screens/MainScreens/Projects/ProjectDetail/widgets/links_widget.dart';
    ...
    if (modulesProvider.moduleDetailState == StateEnum.loading) {
      ...
      return ListView(
        children: [
          ...
          const SizedBox(height: 30),
          assigneesWidget(ref: ref, detailData: modulesProvider.moduleDetailsData['distribution']),
          const SizedBox(height: 30),
