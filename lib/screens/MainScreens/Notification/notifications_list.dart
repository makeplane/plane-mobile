       ...
       widget.data.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                bool isUnread = false;
                for (var element in notificationProvider.unread) {
                ...
                return GestureDetector(
                  onTap: () {
                    notificationProvider
                        .markAsRead(widget.data[index]['id'].toString());

                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => IssueDetail(
                          projID: widget.data[index]["project"],
                          issueId: widget.data[index]['data']['issue']['id']
                              .toString(),
                          appBarTitle:
                  ...
                  child: Slidable(
                    endActionPane: ActionPane(
                      ...
                      children: [
                        ...
                        SlidableAction(
                          onPressed: ((context) {
                            notificationProvider.archiveNotification(
                              widget.data[index]['id'].toString(),
