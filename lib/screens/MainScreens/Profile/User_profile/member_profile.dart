                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: memberprofileProvider.memberProfile['user_data']['avatar'] != null &&
                                        memberprofileProvider
                                            .memberProfile['user_data']['avatar']
                                            .toString()
                                            .isNotEmpty
                                    ? null
                                    : const Color.fromRGBO(55, 65, 81, 1),
                                borderRadius: BorderRadius.circular(4)),
                            child: memberprofileProvider.memberProfile['user_data']['avatar'] == null || memberprofileProvider.memberProfile['user_data']['avatar'].toString().isEmpty
                                ? CustomText(
                                    memberprofileProvider
                                        .memberProfile['user_data']
                                            ['first_name'][0]
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (ctx, index) {
                        ...
                        int percentage = assignedIssues == 0
                            ? 0
                            : double.parse(
                                    ((completedIssues / assignedIssues) * 100)
                                        .toString())
                                .round();
                        return Column(
                          children: [
