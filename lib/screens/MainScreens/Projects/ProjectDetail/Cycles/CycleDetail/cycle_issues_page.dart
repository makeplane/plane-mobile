...
import 'package:plane/screens/MainScreens/Projects/ProjectDetail/Cycles/CycleDetail/cycle_details_page.dart';
...
class _CycleDetailState extends ConsumerState<CycleDetail> {
  ...
  Future getChartData(Map<String, dynamic> data) async {
    data.forEach((key, value) {
      chartData.add(ChartData(DateTime.parse(key), value != null ? value.toDouble() : 0));
    });
  }
