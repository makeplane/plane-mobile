...
class IssuesOrderBYHelper {
  static Map<String, List<IssueModel>> _orderBYManual(
  ...
  static Map<String, List<IssueModel>> _orderBYLastCreated(
      Map<String, List<IssueModel>> issues) {
    issues.forEach((key, value) {
      value.sort((a, b) =>
  ...
  static Map<String, List<IssueModel>> _orderBYLastUpdated(
      Map<String, List<IssueModel>> issues) {
    issues.forEach((key, value) {
      value.sort((a, b) =>
  ...
  static Map<String, List<IssueModel>> _orderBYStartDate(
      Map<String, List<IssueModel>> issues) {
    issues.forEach((key, value) {
      value.sort((a, b) {
  ...
  static Map<String, List<IssueModel>> _orderBYPriority(
      Map<String, List<IssueModel>> issues) {
  ...
  static Map<String, List<IssueModel>> orderIssues(
    Map<String, List<IssueModel>> issues,
    OrderBY orderBY, {
    ...
    // base issue order
    Map<String, List<IssueModel>> orderedIssues = _orderBYLastCreated(issues);
