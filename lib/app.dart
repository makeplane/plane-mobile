    ...
    return Scaffold(
        body: (profileProv.getProfileState == StateEnum.loading ||
            ...
            : !profileProv.userProfile.isOnboarded! ? (
              !profileProv.userProfile.onboardingStep!['profile_complete'] ?
                const SetupProfileScreen():
                 !profileProv.userProfile.onboardingStep!['workspace_create'] ?
                    const SetupWorkspace() :
                    !profileProv.userProfile.onboardingStep!['workspace_invite'] ?
                      const InviteCOWorkers() :
                        !profileProv.userProfile.onboardingStep!['workspace_join'] ?
                          const JoinWorkspaces(fromOnboard: true,) : 
                            const SignInScreen()
            )
