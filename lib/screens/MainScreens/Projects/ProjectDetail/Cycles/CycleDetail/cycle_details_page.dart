...
import 'package:plane/screens/MainScreens/Projects/ProjectDetail/widgets/assignee_widget.dart';
import 'package:plane/screens/MainScreens/Projects/ProjectDetail/widgets/assignees_widget.dart';
import 'package:plane/screens/MainScreens/Projects/ProjectDetail/widgets/progress_chart.dart';
import 'package:plane/screens/MainScreens/Projects/ProjectDetail/widgets/states_widget.dart';
...
class CycleDetailsPage extends ConsumerStatefulWidget {
  const CycleDetailsPage(
      {super.key, required this.cycleId, required this.chartData});
...
class _CycleDetailsPageState extends ConsumerState<CycleDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (cyclesProvider.cyclesDetailState == StateEnum.loading) {
      return Center(
        child: SizedBox(
          width: 30,
          height: 30,
      ...
      return ListView(
        children: [
          ...
          const SizedBox(height: 30),
          assigneesWidget(ref: ref, detailData: cyclesProvider.cyclesDetailsData),
          const SizedBox(height: 30),
