class CyclesModel {
	...
	CyclesModel.fromJson(Map<String, dynamic> json) {
		id = json['id'];
		ownedBy = json['owned_by'] != null ? OwnedBy.fromJson(json['owned_by']) : null;
		...
		if (json['assignees'] != null) {
			assignees = <Assignees>[];
			json['assignees'].forEach((v) { assignees!.add(Assignees.fromJson(v)); });
		}
		totalEstimates = json['total_estimates'];
		completedEstimates = json['completed_estimates'];
		startedEstimates = json['started_estimates'];
		workspaceDetail = json['workspace_detail'] != null ? WorkspaceDetail.fromJson(json['workspace_detail']) : null;
